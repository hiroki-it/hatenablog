...
1. リクエストの宛先ポート (例：`50000`) で、リスナー (例：`0.0.0.0_50000`) を絞り込みます。
2. HTTPSを処理するための各種フィルターを選びます。
3. HTTPフィルターにより、リクエストの宛先ポートで、Serviceを絞り込みます。これが、ルート (例：`50000`) になります。
...
<ul class="decimal">
  <li value="7">L7ロードバランシングされたリクエストの宛先ポート (例：<code>50000</code>) で、リスナー (例：<code>0.0.0.0_50000</code>) を絞り込みます。</li>
  <li>HTTPSを処理するための各種フィルターを選びます。</li>
  <li>HTTPフィルターにより、リクエストの宛先ポートで、Serviceを絞り込みます。これが、ルート (例：<code>50000</code>) になります。</li>
...
1. リクエストの宛先ポート (例：`50010`) で、リスナー (例：`0.0.0.0_50010`) を絞り込みます。
2. HTTPSを処理するための各種フィルターを選びます。
3. HTTPフィルターにより、リクエストの宛先ポートで、Serviceを絞り込みます。これが、ルート (例：`50010`) になります。
...
<ul class="decimal">
  <li value="7">L7ロードバランシングされたリクエストの宛先ポート (例：<code>50010</code>) で、リスナー (例：<code>0.0.0.0_50010</code>) を絞り込みます。</li>
  <li>HTTPSを処理するための各種フィルターを選びます。</li>
  <li>HTTPフィルターにより、リクエストの宛先ポートで、Serviceを絞り込みます。これが、ルート (例：<code>50010</code>) になります。</li>
...
1. リクエストの宛先ポート (例：`443`) で、リスナー (例：`0.0.0.0_443`) を絞り込みます。
2. HTTPSを処理するための各種フィルターを選びます。
3. HTTPフィルターにより、リクエストの宛先ポートで、Serviceを絞り込みます。これが、ルート (例：`443`) になります。
4. HTTPフィルターにより、リクエストの宛先ホスト/パスで、Serviceを絞り込みます。これは、Istio EgressGateway Serviceであるため、クラスター (例：`outbound|443|istio-egressgateway-service.foo-namespace.svc.cluster.local`) になります。
...
<ul class="decimal">
  <li value="7">L7ロードバランシングされたリクエストの宛先ポート (例：<code>443</code>) で、リスナー (例：<code>0.0.0.0_443</code>) を絞り込みます。</li>
</ul>
