...
4. HTTPフィルターにより、Istio EgressGatewayに宛先を変更します。これが、クラスター (例：`outbound|443|istio-egressgateway-service.foo-namespace.svc.cluster.local`) になります。
