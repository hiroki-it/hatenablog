...
表で対応関係の一覧を示した後、リクエストの仕組みの中に当てはめて図式化しました。
...
上記の解説のイメージが掴めるかと思います。

送信元または宛先のEnvoyでほとんど同じリソースが登場しますが、 Gatewayは送信元のEnvoyだけで登場します。
...
Gatewayが送信元のEnvoyだけで登場することがわかりやすくなりました。
...
送信元または宛先のEnvoyで同じリソースが登場することがわかりやすくなりました。
