...
<br>
<br>
つまり、iptablesのルールはデフォルトのままになっています👍🏻
</div>
...
<div class="text-box">
<div class="text-box-title">▶︎ Istio EgressGateway内のiptablesについて</div>
<br>
...
classDef red fill: #EA6B66, font-weight :bold, stroke: black;
class リスナー,リスナーフィルター,ネットワークフィルター,ルート,クラスター,エンドポイント red
```
