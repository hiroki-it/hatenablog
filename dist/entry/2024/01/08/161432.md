...
<br>
<blockquote>
<ul><li>[https://github.com/istio/istio/blob/1.20.2/tools/packaging/common/envoy_bootstrap.json:title]</li></ul>
<ul><li>[https://github.com/istio/istio/blob/1.20.2/pilot/docker/Dockerfile.proxyv2#L27-L29:title]</li></ul>
</blockquote>
</div>
...
<div class="text-box">
`istio-proxy`コンテナは、<code>127.0.0.6</code>を指定し、HTTPSリクエストをリダイレクトします。
<br>
<br>
