...
<br>
Istioコントロールプレーンは、前述の責務以外にもカスタムコントローラーとしての責務も担います。
<br>
<br>
以前は、IstioOperatorがカスタムリソースコントローラーとして責務を担っていましたが、執筆時点 (2024/01/16) では非推奨となっています。
<br>
<br>
その代わりに、Istioコントロールプレーンがこれを担うようになりました👍🏻
<br>
<blockquote>
<ul>
