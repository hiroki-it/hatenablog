...
<!-- TOC -->
* [01. はじめに](#01-はじめに)
* [02. Istioのアップグレード手法を説明する前に](#02-istioのアップグレード手法を説明する前に)
  * [カナリアリリースとは](#カナリアリリースとは)
  * [カナリアリリースの手順](#カナリアリリースの手順)
  * [『カナリアリリース』の呼称の由来](#カナリアリリースの呼称の由来)
* [03. アップグレード手法の概要](#03-アップグレード手法の概要)
* [04. アップグレード手法の詳細](#04-アップグレード手法の詳細)
  * [前提](#前提)
  * [`【１】` アップグレード前の検証](#-アップグレード前の検証)
  * [`【２】` 新Istiodのインストール](#-新istiodのインストール)
  * [`【３】` リビジョン番号の変更](#-リビジョン番号の変更)
    * [`istioctl tag set`コマンド](#istioctl-tag-set-コマンド)
  * [`【４】` IngressGatewayをインプレースアップグレード](#-ingressgatewayをインプレースアップグレード)
  * [`【５】` 一部のNamespaceの`istio-proxy`コンテナをアップグレード](#-一部のnamespaceの-istio-proxy-コンテナをアップグレード)
  * [`【６】` ユーザの手を借りたテスト](#-ユーザの手を借りたテスト)
    * [もし問題が起こった場合](#もし問題が起こった場合)
  * [`【７】` `istio-proxy`コンテナの段階的なアップグレード](#-istio-proxy-コンテナの段階的なアップグレード)
  * [`【８】` 旧Istiodのアンインストール](#-旧istiodのアンインストール)
* [05. おわりに](#05-おわりに)
<!-- TOC -->
