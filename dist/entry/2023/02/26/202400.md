...
**<font color="#FF0000">Namespaceで`istio.io/rev`ラベルに`default`を設定しておけば、MutatingWebhookConfigurationがそれを検知し、特定のIstioのバージョンのServiceにWebhookを送信できるようになっています。</font>**
