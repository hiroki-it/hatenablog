...
さて、最近の業務でIstioをひたすらアップグレードしています。

採用したアップグレード手法の紹介も兼ねて、Istioの安全なアップグレード手法の仕組みに関する記事を投稿しました🚀
...
それでは、Istioの安全なアップグレード手法の仕組みをもりもり布教しようと思います😗
...
<div class="text-box">
istio-proxyコンテナのインジェクションについては、こちら記事で説明してます。
<br>
<br>
もし気になる方はこちらもよろしくどうぞ🙇🏻‍
<br>
...
<br>
<br>
すると、上記のMutatingWebhookConfigurationがこれを検知し、特定のIstioのバージョンのServiceにWebhookを送信してくれます👍🏻
<br>
<br>
↪️ 参考：[https://istio.io/latest/blog/2021/revision-tags/:title]
<br>
</div>
...
<br>
<br>
この点については、DeploymentがローリングアップグレードでIngressGatewayのPodを入れ替えるため、安心していただいて問題ありません🙆🏻‍♂️♂️
<br>
</div>
