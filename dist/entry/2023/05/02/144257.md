...
<br>
<br>
ですが本記事で解説した通り、ArgoCDはcmp-serverの<code>helm template</code> (この時、<code>--include-crds</code>オプションが有効になっている) や、application-controllerの<code>kubectl apply</code>コマンドを組み合わせてマニフェストをデプロイしているため、CRDもちゃんと更新してくれます👍🏻
<br>
<blockquote>
