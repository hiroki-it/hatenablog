...
ここからは、KubernetesのマルチテナントパターンをArgoCDで具体的に実践し、おすすめのパターン実践方法を解説していきます。
...
<table>
   <tbody>
      ...
      <tr>
         <td colspan="2" style="text-align: center;">ArgoCDでの<br>パターン実践名</td>
         <td style="text-align: center;"><a href="#実Clusterテナント">実Cluster<br>テナント</a></td>
         <td style="text-align: center;"><a href="#仮想Clusterテナント---">仮想Cluster<br>テナント</a></td>
         <td style="text-align: center;"><a href="#04-04-Namespaces-as-a-Service-の実践">Namespace<br>テナント</a></td>
         <td style="text-align: center;"><a href="#05-CLモードなArgoCD">Project<br>テナント<br><nobr>(CLモード)</nobr></a></td>
         <td style="text-align: center;"><a href="#05-02-NSモードなArgoCD---">Project<br>テナント<br><nobr>(NSモード)</nobr></a></td>
      </tr>
      <tr>
...
KubernetesのマルチテナントパターンとArgoCDでのパターン実践方法をもりもり布教しました。
...
また、ArgoCDでのパターン実践方法の収集にあたり、以下の方からの意見も参考にさせていただきました。
