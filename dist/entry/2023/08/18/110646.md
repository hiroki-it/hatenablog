...
<table>
   <tbody>
      ...
      <tr>
         <td rowspan="2">テナント間のKubernetesリソース分離<br>(分離できていれば ✅ )</td>
...
<table>
   <tbody>
      ...
      <tr>
         <td colspan="2" style="text-align: center;">テナント実践</td>
      ...
      <tr>
         <th colspan="2">ArgoCDがテナント間で<br>独立 / 共有</th>
      ...
      <tr>
         <td rowspan="2" style="text-align: center;">テナント間のKubernetesリソース分離<br>(分離できていれば ✅ )</td>
         <td style="text-align: center;">Namespacedスコープ<br>リソース</td>
         <td style="text-align: center;">✅</td>
         <td style="text-align: center;">✅</td>
         <td style="text-align: center;">✅</td>
