...
- ArgoCDのAppProjectテナントがマニフェストのデプロイを制限する仕組み
...
- [ArgoCDでのテナントパターン実践方法の一覧](#04-ArgoCDでのテナントパターン実践方法の一覧) (4章)
...
<table>
   <tbody>
      ...
      <tr>
         <td colspan="2" style="text-align: center;">テナントパターン<br>実践方法名</td>
         ...
         <td style="text-align: center;"><a href="#05-CLモードなArgoCD">AppProject<br>テナント<br><nobr>(CLモード)</nobr></a></td>
         <td style="text-align: center;"><a href="#05-02-NSモードなArgoCD---">AppProject<br>テナント<br><nobr>(NSモード)</nobr></a></td>
      </tr>
      <tr>
         <td colspan="2" style="text-align: center;">ArgoCDがテナント間で独立 / 共有</td>
...
NSモードなArgoCDの場合、前述のCLモードとは異なり、各AppProjectテナント間で独立したArgoCDを管理します。
...
# 06. AppProjectテナントのデプロイ制限の仕組み

そろそろ解説を読むのがしんどい方がいるのではないでしょうか。

『君がッ、泣くまで、解説をやめないッ！』

AppProjectテナントがマニフェストのデプロイをどのように制限するのかについて、例を挙げて解説します。
