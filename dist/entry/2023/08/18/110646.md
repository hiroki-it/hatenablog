...
<table>
   <tbody>
      ...
      <tr>
         <th colspan="2" style="text-align: center;"></th>
         <th style="text-align: center; color: white"><a href="#実Clusterテナント">実Cluster<br>テナント</a></th>
         <th style="text-align: center; color: white"><a href="#仮想Clusterテナント---">仮想Cluster<br>テナント</a></th>
         <th style="text-align: center; color: white"><a href="#04-04-Namespaces-as-a-Service-の実践">Namespace<br>テナント</a></th>
         <th style="text-align: center; color: white"><a href="#05-CLモードなArgoCD">AppProject<br>テナント<br><nobr>CLモード</nobr></a></th>
         <th style="text-align: center; color: white"><a href="#05-02-NSモードなArgoCD---">AppProject<br>テナント<br><nobr>NSモード</nobr></a></th>
      </tr>
      </thead>
      <tr>
