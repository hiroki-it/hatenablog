...
本記事では、このサイドカーのインジェクションの仕組みをもりもり布教していきます😗
...
> ↪️：[https://istio.io/latest/docs/ops/deployment/architecture/:title]
...
> ↪️：[https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/#which-plugins-are-enabled-by-default:title]
...
> ↪️：[https://pkg.go.dev/k8s.io/api@v0.24.3/admission/v1#AdmissionReview:title]
...
> ↪️：[https://kubernetes.io/docs/reference/access-authn-authz/extensible-admission-controllers/#request:title]
...
> ↪️：[https://kubernetes.io/docs/reference/access-authn-authz/extensible-admission-controllers/#response:title]
...
> ↪️：[https://www.amazon.co.jp/dp/B09XN9RDY1/:title]
...
> ↪️：[https://istio.io/latest/blog/2021/direct-upgrade/#upgrade-from-18-to-110:title]

<div class="text-box">
<code>istio.io/rev</code>ラベル値は、どんなエイリアスでも良いです。
<br>
<br>
...
<div class="text-box">
本記事では詳しく言及しませんが、上記のpathc処理ではサイドカーコンテナの<code>istio-proxy</code>コンテナの他に、InitContainerの<code>istio-init</code>コンテナもインジェクションできるようにします。
<br>
<br>
この<code>istio-init</code>コンテナは、<code>istio-proxy</code>コンテナを持つPodでインバウンド/アウトバウンド通信の経路を制御するために、Pod内にiptablesのルールを適用する責務を担っています💪🏻
<br>
<blockquote>
↪️：[https://www.sobyte.net/post/2022-07/istio-sidecar-proxy/#sidecar-traffic-interception-basic-process:title]
<br>
<br>
</blockquote>
</div>
...
> ↪️：[https://github.com/istio/istio/blob/1.14.3/pkg/kube/inject/webhook.go#L908-L915:title]
...
<br>
<blockquote>
↪️：[https://medium.com/jorgeacetozi/kubernetes-master-components-etcd-api-server-controller-manager-and-scheduler-3a0179fc8186/:title]
<br>
<br>
</blockquote>
</div>
...
そのため、MutatingAdmissionWebhookプラグインをどのように使っているのかを一度知れば、知識の汎用性が高いと考えています✌️
