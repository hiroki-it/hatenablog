...
```sh
🏭 foo-repository/
├── backend.tf # foo コンポーネントの terraform.tfstate ファイルを指定する
...
```
...
│
└── 📂 bar/
      ├── backend.tf # bar コンポーネントの terraform.tfstate ファイルを指定する
      ...
```
...
🪣 foo-bucket/
│
└── terraform.tfstate # foo コンポーネントの状態を持つ
```

```sh
🪣 bar-bucket/
│
└── terraform.tfstate # bar コンポーネントの状態を持つ
```
...
├── vpc.tf
├── 📂 tes/ # Tes環境
│    ├── backend.tfvars # Tes環境用の network コンポーネントの terraform.tfstate ファイルを指定する
│    ...
│
├── 📂 stg/ # Stg環境
│    ├── backend.tfvars # Stg環境用の network コンポーネントの terraform.tfstate ファイルを指定する
│    ...
│
└── 📂 prd/ # Prd環境
      ├── backend.tfvars # Prd環境用の network コンポーネントの terraform.tfstate ファイルを指定する
      ...
```
...
│
└── 📂 network
      └── terraform.tfstate # network コンポーネントの状態を持つ
```
...
├── s3.tf
├── 📂 tes/ # Tes環境
│    ├── backend.tfvars # Tes環境用の frontend チームの terraform.tfstate ファイルを指定する
│    ...
│
├── 📂 stg/ # Stg環境
│    ├── backend.tfvars # Stg環境用の frontend チームの terraform.tfstate ファイルを指定する
│    ...
│
└── 📂 prd/ # Prd環境
      ├── backend.tfvars # Prd環境用の frontend チームの terraform.tfstate ファイルを指定する
      ...
```
...
├── rds.tf
├── 📂 tes
│    ├── backend.tfvars # Tes環境用の backend チームの terraform.tfstate ファイルを指定する
│    ...
│
├── 📂 stg
│    ├── backend.tfvars # Stg環境用の backend チームの terraform.tfstate ファイルを指定する
│    ...
│
└── 📂 prd
      ├── backend.tfvars # Prd環境用の backend チームの terraform.tfstate ファイルを指定する
       ...
```
...
🪣 tes-bucket/
├── 📂 frontend-team
│    └── terraform.tfstate # frontend チームの状態を持つ
│
├── 📂 backend-team
│    └── terraform.tfstate # backend チームの状態を持つ
│
└── 📂 sre-team
...
│    ├── sns.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の application コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の application コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の application コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
├── 📂 auth/
│    ├── provider.tf
...
│    ├── iam.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の auth コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の auth コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の auth コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
├── 📂 monitor/
│    ├── provider.tf
...
│    ├── cloudwatch.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の monitor コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の monitor コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の monitor コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
└── 📂 network
      ├── provider.tf
...
🪣 tes-bucket/
├── 📂 application
│    └── terraform.tfstate # application コンポーネントの状態を持つ
│
├── 📂 auth
│    └── terraform.tfstate # auth コンポーネントの状態を持つ
│
├── 📂 monitor
│    └── terraform.tfstate # monitor コンポーネントの状態を持つ
│
└── 📂 network
      └── terraform.tfstate # network コンポーネントの状態を持つ
```
...
│    ├── codedeploy.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の cicd コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の cicd コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の cicd コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
├── 📂 datastore/
│    ├── provider.tf
...
│    ├── s3.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の datastore コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の datastore コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の datastore コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
├── 📂 monitor/
│    ├── provider.tf
...
│    ├── iam.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の high-freq コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の high-freq コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の high-freq コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
├── 📂 low-freq # 低頻度変更グループ
│    ├── provider.tf
...
│    ├── vpc.tf
│    ├── 📂 tes
│    │    ├── backend.tfvars # Tes環境用の low-freq コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg
│    │    ├── backend.tfvars # Stg環境用の low-freq コンポーネントの terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd
│          ├── backend.tfvars # Prd環境用の low-freq コンポーネントの terraform.tfstate ファイルを指定する
│          ...
│
└── 📂 middle-freq # 中頻度変更グループ (高頻度とも低頻度とも言えないリソース)
      ...
      ├── ses.tf
      ├── 📂 tes
      │    ├── backend.tfvars # Tes環境用の middle-freq コンポーネントの terraform.tfstate ファイルを指定する
      │    ...
      │
      ├── 📂 stg
      │    ├── backend.tfvars # Stg環境用の middle-freq コンポーネントの terraform.tfstate ファイルを指定する
      │    ...
      │
      └── 📂 prd
           ├── backend.tfvars # Prd環境用の middle-freq コンポーネントの terraform.tfstate ファイルを指定する
           ...
```
...
🪣 tes-bucket/
├── 📂 high-freq
│    └── terraform.tfstate # high-freq コンポーネントの状態を持つ
│
├── 📂 middle-freq
│    └── terraform.tfstate # middle-freq コンポーネントの状態を持つ
│
└── 📂 low-freq
      └── terraform.tfstate # low-freq コンポーネントの状態を持つ
```
...
│    ├── ses.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の frontend チームの application/terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の frontend チームの application/terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の frontend チームの application/terraform.tfstate ファイルを指定する
│          ...
│
└── 📂 monitor/
      ├── provider.tf
      ...
      ├── cloudwatch.tf
      ├── 📂 tes/ # Tes環境
      │    ├── backend.tfvars # Tes環境用の frontend チームの monitor/terraform.tfstate ファイルを指定する
      │    ...
      │
      ├── 📂 stg/ # Stg環境
      │    ├── backend.tfvars # Stg環境用の frontend チームの monitor/terraform.tfstate ファイルを指定する
      │    ...
      │
      └── 📂 prd/ # Prd環境
            ├── backend.tfvars # Prd環境用の frontend チームの monitor/terraform.tfstate ファイルを指定する
            ...
```
...
│    ├── sns.tf
│    ├── 📂 tes/ # Tes環境
│    │    ├── backend.tfvars # Tes環境用の backend チームの application/terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    ├── 📂 stg/ # Stg環境
│    │    ├── backend.tfvars # Stg環境用の backend チームの application/terraform.tfstate ファイルを指定する
│    │    ...
│    │
│    └── 📂 prd/ # Prd環境
│          ├── backend.tfvars # Prd環境用の backend チームの application/terraform.tfstate ファイルを指定する
│          ...
│
└── 📂 monitor/
      ├── provider.tf
      ...
      ├── cloudwatch.tf
      ├── 📂 tes/ # Tes環境
      │    ├── backend.tfvars # Tes環境用の backend チームの monitor/terraform.tfstate ファイルを指定する
      │    ...
      │
      ├── 📂 stg/ # Stg環境
      │    ├── backend.tfvars # Stg環境用の backend チームの monitor/terraform.tfstate ファイルを指定する
      │    ...
      │
      └── 📂 prd/ # Prd環境
            ├── backend.tfvars # Prd環境用の backend チームの monitor/terraform.tfstate ファイルを指定する
            ...
```
...
├── 📂 frontend-team
│    ├── 📂 application
│    │    └── terraform.tfstate # frontendチームの application コンポーネントの状態を持つ
│    │
│    └── 📂 monitor
│         └── terraform.tfstate # frontendチームの monitor コンポーネントの状態を持つ
│
├── 📂 backend-team
│    ├── 📂 application
│    │    └── terraform.tfstate # backendチームの application コンポーネントの状態を持つ
│    │
│    └── 📂 monitor
│          └── terraform.tfstate # backendチームの monitor コンポーネントの状態を持つ
│
└── 📂 sre-team
      ├── 📂 application
      │    └── terraform.tfstate # sreチームの application コンポーネントの状態を持つ
      │
      ├── 📂 auth
      │    └── terraform.tfstate # sreチームの auth コンポーネントの状態を持つ
      │
      ├── 📂 monitor
      │    └── terraform.tfstate # sreチームの monitor コンポーネントの状態を持つ
      │
      └── 📂 network
            └── terraform.tfstate # sreチームの network コンポーネントの状態を持つ
```
