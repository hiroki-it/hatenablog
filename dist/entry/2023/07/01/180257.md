...
<thead>
  <tr style="text-align: center;">
    <th>必<br>須<br>・<br>任<br>意</th><th>分割パターン<br>大分類</th><th>対応する<br>リポジトリ<br>構成</th><th>対応するリモートバックエンド<br>構成</th><th>分割パターン<br>小分類</th><th>おすすめ</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td rowspan="2">必須</td><td>上層</td><td>リポジトリ自体<br>または上層ディレクトリー</td><td>リモートバックエンド自体<br>または上層ディレクトリー</td><td>プロバイダーのアカウント別</td><td align=center><code>⭕️</code></td>
  </tr>
  <tr>
    <td>下層</td><td>下層ディレクトリー</td><td>下層ディレクトリー</td><td>実行環境別</td><td align=center><code>⭕️</code></td>
  </tr>
  <tr>
    <td rowspan="6">任意</td><td rowspan="6">中間層</td><td rowspan="6">中間層ディレクトリー</td><td rowspan="6">中間層ディレクトリー</td><td>同じテナント内のプロダクト別</td><td></td>
  </tr>
  <tr>
