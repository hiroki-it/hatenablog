...
flowchart TB
    subgraph AWS
        subgraph tes-bucket
            foo["foo-product-tfstate<br>(アプリを動かすプラットフォームのAWSリソース)"]-..->network
            bar["bar-product-tfstate<br>(アプリを動かすプラットフォームのAWSリソース)"]-..->network
...
├── remote_state.tf # 他の tfstate ファイルに依存する
├── 📂 tes/ # Tes環境
│    ├── backend.tfvars # foo-productの状態を持つ terraform.tfstate ファイルを指定する
│    ...
│
├── 📂 stg/ # Stg環境
│    ├── backend.tfvars # foo-productの状態を持つ terraform.tfstate ファイルを指定する
...
├── remote_state.tf # 他の tfstate ファイルに依存する
├── 📂 tes/ # Tes環境
│    ├── backend.tfvars # bar-productの状態を持つ terraform.tfstate ファイルを指定する
│    ...
│
├── 📂 stg/ # Stg環境
│    ├── backend.tfvars # bar-productの状態を持つ terraform.tfstate ファイルを指定する
...
🪣 tes-bucket/
├── 📂 foo-product
│    └── terraform.tfstate # foo-productの状態を持つ
│
├── 📂 bar-product
│    └── terraform.tfstate # bar-productの状態を持つ
│
└── 📂 network
