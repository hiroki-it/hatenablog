...
<div class="text-box">
一部のプロバイダーは、分割できず、他のプロバイダーと同じ<code>tfstate</code>ファイルで状態を管理せざるを得ない場合 (例：KubernetesのプロバイダーをEKSの同じ<code>tfstate</code>ファイルで管理) があります👍
<br>
<blockquote>
[https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs:title]
<br>
<br>
</blockquote>
</div>
