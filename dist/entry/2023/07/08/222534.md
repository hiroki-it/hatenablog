...
Projectテナントでは、テナントごとにNamespaceと複数のAppProjectを作成します。

Projectテナントは二重のテナント (**<font color="#FF0000">第一テナントにNamespace、第二テナントに複数のAppProject</font>**) を持っています。

AppProjectは、**<font color="#FF0000">テナント内のApplicationをグループ化</font>** します。
...
しかし、AppProjectのCRDの`.spec.scope`キーからも分かる通り、AppProjectはNamespacedスコープなカスタムリソースです。
