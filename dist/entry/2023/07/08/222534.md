...
# 05. NamespacedスコープモードArgoCDのAppProjectテナントの分割パターン

## 概要

それでは、NamespacedスコープモードArgoCDのAppProjectテナントをオススメする場合に、テナントをどのような粒度で作成するべきなのかを考えていきましょう。

前述の通り、NamespacedスコープモードArgoCDでは、NamespaceとAppProjectの両方の粒度を考える必要があります。

<table>
<thead>
  <tr>
    <th>テナント間の分離度</th><th>Namespaceの粒度</th><th>AppProjectの粒度</th><th>オススメ</th>
  </tr>
</thead>
<tbody>
  <tr>
