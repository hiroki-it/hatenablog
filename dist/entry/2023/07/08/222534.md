...
- [Projectテナントのアクセス制限の仕組み](#06-Projectテナントのアクセス制限の仕組み) (6章)
...
すなわち、Projectテナントは二重のテナント (**<font color="#FF0000">第一テナントにNamespace</font>**、**<font color="#FF0000">第二テナントに複数のAppProject</font>**) を持ち、両方のテナントでアクセスを制限します。
...
NSモードと同様にして、AppProjectに所属するApplicationに関するアクセス制限を設定できます。
...
全てのNamespaceにアクセスできるように、`--application-namespaces`オプションに`*` (アスタリスク) を設定しています。
...
CLモードと同様にして、AppProjectに所属するApplicationに関するアクセス制限を設定できます。
。
