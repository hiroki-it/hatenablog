...
| スコープモードの種類                   | ArgoCDは独立/共有 | ArgoCDの認可                                                                |
| -------------------------------------- | ----------------- | --------------------------------------------------------------------------- |
...
仮に無許可のNamespaceでApplicationを作れてしまうと、そのApplicationから、誤ったClusterにマニフェストをデプロイできてしまいます☠️
...
仮に無許可のClusterをデプロイ先に指定できてしまうと、誤ったClusterにマニフェストをデプロイできてしまいます☠️
...
仮に無許可のNamespaceをデプロイ先に指定できてしまうと、誤ったNamespaceにマニフェストをデプロイできてしまいます☠️
