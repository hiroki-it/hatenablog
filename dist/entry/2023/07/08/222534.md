...
<table>
   <thead>
      <tr>
         <th style="text-align: center;">マルチテナントパターン</th>
         <th>説明</th>
         <th style="text-align: center;">テナント名</th>
         <th>ツール</th>
      </tr>
   </thead>
   <tbody>
      ...
      <tr>
         ...
         <td>virtualcluster、vcluster、kcp、tensile-kube</td>
      </tr>
      <tr>
...
<br>
<blockquote>
<ul><li>[asin:B072TS9ZQZ:title]</li></ul>
<ul><li>[https://kubernetes.io/docs/concepts/security/multi-tenancy/#isolation:title]</li></ul>
<ul><li>[https://aws.github.io/aws-eks-best-practices/security/docs/multitenancy/:title]</li></ul>
<br>
</blockquote>
</div>
...
Clusters-as-a-Serviceモデルの実装方法として、例えば以下の種類があります。

<table>
  <thead>
    <tr>
      <th style="text-align: center;">テナント<br>パターン</th>
      <th>説明</th>
    </tr>
    <tr></tr>
  </thead>
...
Namespaces-as-a-Serviceモデルの実装方法として、例えば以下の種類があります。
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align: center;">階層的Namespace<br>テナント</td>
      <td>...</td>
    </tr>
    <tr>
      <td style="text-align: center;">Namespace<br>テナント</td>
...
ここからは、実際にArgoCDのマルチテナント設計で候補になるパターンを紹介していきます。

私が候補として考えたパターン配下の通りです。

<table>
  <thead>
    <tr>
      <th rowspan="2">マルチ<br><nobr>テナント</nobr><br>パターン</th>
      <th rowspan="2" style="text-align: center;">テナント名</th>
  ...
  <tbody>
    ...
    <tr>
      <td rowspan="2" style="text-align: center;">Namespaces-as-a-Service<br>モデル</td>
      <td style="text-align: center;">Namespace<br>テナント</td>
    ...
    <tr>
      <td style="text-align: center;">AppProject<br>テナント</td>
