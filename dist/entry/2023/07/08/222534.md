---
Title: 【ArgoCD🐙️】ArgoCDのApplicationを分離するテナント分割パターンと認可設計
Category:
  - ArgoCD
  - Kubernetes
  - ソフトウェアアーキテクチャ
...
単一のテナント内に複数のApplicationを共存させると、単一のArgoCDダッシュボードから全てのApplicationを操作できて便利です。

ただし、Applicationが増えていくにつれて、問題が起こり始めます。
