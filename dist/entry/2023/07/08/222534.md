...
<table>
  ...
  <tbody style="text-align: center;">
    ...
    <tr>
      ...
      <td>Projectテナント<br>(Namespacedスコープ)</td>
      <td>共有</td>
      <td>✅<br></td>
      <td></td>
      <td>★★</td>
    ...
    <tr>
      <td>Projectテナント<br>(Clusterスコープ)</td>
      <td>独立</td>
      <td>✅</td> 
      <td></td>
      <td>★</td>
...
ただ、後述の **<font color="#FF0000">Projectテナントは、Namespaceテナントを兼ねるパターン</font>** であり、二層テナントを設計できます。
...
そのため、**<font color="#FF0000">ProjectテナントはNamespaceテナントを兼ねる二層なテナントパターン</font>** です。
