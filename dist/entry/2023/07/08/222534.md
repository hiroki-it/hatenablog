...
このArgoCDでは、いくつものClusterに対して、非常にたくさんのマイクロサービスをデプロイする必要がありました。
...
| :---------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------ |
|               拡張性                | -                                                                                                                                                              | テナントを増やすために実Clusterを作成する必要があり、作業量が多い。                       | IaCツールで実      |
|      安全性<br>(セキュリティ)       | 他のテナントからの通信を遮断できる。                                                                                                                           | -                                                                                         |                    |
|               保守性                | 他のテナントとClusterスコープまたはNamespacedスコープなKubernetesリソースを分離できる。これらのKubernetesリソース (特にCRD) の変更が他のテナントに影響しない。 | 各テナントで実Clusterを継続的に保守しないといけない。(例：アップグレード、機能修正、など) |                    |
|                性能                 | 他のテナントとClusterのハードウェアリソースを分け合わずに、これを独占できる。                                                                                  | -                                                                                         |                    |
...
| :---------------------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------- |
|               拡張性                | テナントを増やすために仮想Clusterを作成するだけでよく、実Clusterを作成するよりは作業量が少ない。                                                               | -                                                                                                      | -                                                                                            |
|      安全性<br>(セキュリティ)       | -                                                                                                                                                              | 他のテナントからの通信を遮断できない。                                                                 | ArgoCDの操作に申請が必要であれば、利用者を信頼できる。                                       |
...
|                性能                 | -                                                                                                                                                              | 他のテナントとClusterのハードウェアリソースを奪い合わないといけない。                                  | たくさんの利用者が同時並行的にArgoCDを操作する状況になりにくければ、奪い合いが起こりにくい。 |
