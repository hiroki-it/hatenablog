...
<table>
   <thead>
      <tr>
         ...
         <th style="text-align: center;">テナント<br>パターン名</th>
         <th>説明</th>
         <th>ツール</th>
      </tr>
   </thead>
   <tbody>
      <tr>
         <td style="text-align: center;">Clusters-as-a-Serviceモデル</td>
         <td style="text-align: center;">実Cluster<br>テナント</td>
         <td></td>
         <td>不要</td>
      </tr>
      <tr>
         <td style="text-align: center;">Control-planes-as-a-Serviceモデル</td>
         <td style="text-align: center;">仮想Cluster<br>テナント</td>
         <td></td>
         <td>virtualcluster、vcluster、kcp、tensile-kube</td>
      </tr>
      <tr>
         <td style="text-align: center;">Namespaces-as-a-Serviceモデル</td>
...
<table>
  <thead>
    <tr>
      ...
      <th rowspan="2" style="text-align: center;">テナント<br>パターン名</th>
