...
(4) infraチームは、認可Applicationを操作します。
...
無認可のNamespaceでApplicationを作れてしまうと、そのApplicationから誤ったプロダクト用Clusterにマニフェストをデプロイできてしまいます😈
...
もし、fooプロダクトチームが無認可のAppProject (例：`bar-team`) でApplicationを作成しようとします。
