...
すなわち、Projectテナントは二重のテナント (**<font color="#FF0000">第一テナントにNamespace</font>**、**<font color="#FF0000">第二テナントに複数のAppProject</font>**) を持ち、 これらテナントを使用して、**"あらゆる面から"** マニフェストのデプロイを制限します。
