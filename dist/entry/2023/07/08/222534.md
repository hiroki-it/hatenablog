...
Projectテナントは、マニフェストのデプロイを制限します。
...
<div class="text-box">
Projectテナントは、その他のアクセスも制限を設定できます。
<br>
<br>
...
Projectテナントは、ArgoCD系カスタムリソースに対するReconciliationを制限します。
...
正しくReconciliationを実行する場合、Projectテナントはこれを制限しません。
