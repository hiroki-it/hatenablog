...
ただ、後述の **<font color="#FF0000">AppProjectテナント (特にNSモードなArgoCDの場合) がNamespaceテナントを兼ねる</font>** パターンです。
...
なお、**<font color="#FF0000">AppProjectテナント (特にNSモードなArgoCDの場合) はNamespaceテナントを兼ねる</font>** パターンです。
