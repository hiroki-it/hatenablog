...
ただ、仮想Clusterを運用保守できるつよつよ組織であれば、前述のデメリットはカバーできると判断しました。
...
NSモードなArgoCDでは、ArgoCDの各コンポーネントは、自分自身が属するNamespace内のみにアクセスできます。
...
CLモードなArgoCDでは、ArgoCDの各コンポーネントは、自分自身が属するNamespace以外にもアクセスできます。
