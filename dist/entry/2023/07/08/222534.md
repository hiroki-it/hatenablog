...
カスタムリソース定義からも分かる通り、AppProjectはNamespacedスコープなカスタムリソースであるため、**<font color="#FF0000">AppProjectテナントはNamespaceテナントを兼ねるパターン</font>** です。
...
| スコープモードの種類                   | マルチテナントパターン名 | ArgoCDの影響範囲 | ArgoCDのアクセス可能範囲                                                    |
| -------------------------------------- | ------------------------ | ---------------- | --------------------------------------------------------------------------- |
