...
![argocd_tenant_not](https://raw.githubusercontent.com/hiroki-it/tech-notebook-images/master/images/drawio/blog/argocd/argocd_tenant_not.png)
...
またテナント分割と認可スコープをいい感じに設定すると、許可されていないテナントでは、デプロイ先Clusetr管理者がマニフェストをデプロイできないような仕組みを実現できます。

![argocd_tenant](https://raw.githubusercontent.com/hiroki-it/tech-notebook-images/master/images/drawio/blog/argocd/argocd_tenant.png)
