...
<table>
    <thead>
        <tr>
            <th rowspan="2">テナントパターン</th>
            <th rowspan="2">テナントの単位</th>
            <th colspan="3">テナント間のリソース分離</th>
            <th rowspan="2">Cluster運用つらさ</th>
            <th rowspan="2">採用</th>
        </tr>
        <tr>
            <th>ArgoCD系<br>カスタムリソース</th>
            <th>Namespacedスコープ<br>K8sリソース</th>
            <th>Clusterスコープ<br>K8sリソース</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
もし採用する場合は、ArgoCDの『Clusterスコープモード』を有効化し、Cluster内に単一のArgoCDを動かします。
