...
<table>
  <thead>
    <tr>
      <th rowspan="2">マルチテナンシー<br>モデル</th>
      <th rowspan="2">テナント<br>パターン</th>
      <th rowspan="2">テナントの単位</th>
      <th colspan="2">テナント間のリソース分離<br>分離できていれば ✅</th>
      <th rowspan="2">Cluster<br>運用<br>難易度</th>
      <th rowspan="2">採用</th>
    </tr>
    <tr>
      <th>Namespaced<br>スコープ<br>リソース</th>
      <th>Cluster<br>スコープ<br>リソース</th>
    </tr>
  </thead>
  <tbody>
    <tr>
