...
| スコープモードの種類                                                           | <nobr>ArgoCDはテナント間で独立/共有</nobr> | ArgoCD自体の認可スコープ                                                  |
| ------------------------------------------------------------------------------ | ------------------------------------------ | ------------------------------------------------------------------------- |
| [<nobr>Namespacedスコープモード</nobr><br>(NSモード)](#05-NSモードなArgoCD---) | 独立                                       | ArgoCDの各コンポーネントは、自分自身が属するNamespaceのみにアクセスできる |
| [<nobr>Clusterスコープモード</nobr><br>(CLモード)](#05-NSモードなArgoCD---)    | 共有                                       | ArgoCDの各コンポーネントは、許可された任意のNamespaceにアクセスできる     |
...
AppProjectでは、属するApplicationの操作可能な範囲を設定できます
