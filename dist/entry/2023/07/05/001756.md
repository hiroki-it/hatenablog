...
その一方で、`tfstate`ファイル分割に基づいて設計することにより、**<font color="#FF0000">明確なディレクトリー構成パターン</font>** として抽出できるようになります。
...
なお、全てが実用的なパターンというわけでないので、オススメするものを ★ としています。

<table>
<thead>
  <tr>
    <th><nobr>必須</nobr><br>・<br><nobr>任意</nobr></th><th>tfstate<br><nobr>分割パターン</nobr><br>大分類</th><th>tfstate<br><nobr>分割パターン</nobr><br>小分類</th><th><nobr>オススメ</nobr></th><th>対応する<br><nobr>リポジトリ構成 🏭</nobr></th><th>対応する<br><nobr>リモートバックエンド構成 🪣</nobr></th>
  </tr>
</thead>
<tbody>
  <tr>
