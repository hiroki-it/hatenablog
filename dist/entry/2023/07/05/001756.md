...
<div class="text-box">
本記事では、ローカルモジュールのディレクトリ構成は、設計に含めていません。
<br>
<br>
混同しやすいのですが、<code>tfstate</code>ファイル分割に基づくディレクトリ構成とローカルモジュール内のそれは、別のテーマとして切り離して考えることができます👍
<br>
<br>
そもそも、リポジトリ内で<code>resource</code>ブロックを汎用的に使い回したい要件がなかなか無く、ローカルモジュールはなくても困らないのですが...
</div>
