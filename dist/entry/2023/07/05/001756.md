...
異なるリポジトリに`tfstate`ファイルをおいた方がよい場合については、[分割パターン](#06-tfstateファイルの分割パターン) で説明しています。
...
異なるリモートバックエンドに`tfstate`ファイルをおいた方がよい場合については、[分割パターン](#06-tfstateファイルの分割パターン) で説明しています。
